...
NSString * const MDDQueueObjectDomainPrefix = @"com.bilibili.queue.object#";

@interface MDDQueueObject ()
...
@implementation MDDQueueObject

- (instancetype)init{
    if (self = [super init]) {
        NSString *queueName = [MDDQueueObjectDomainPrefix stringByAppendingString:NSStringFromClass([self class])];
